...
o_model = "o_deploy_less_opt.prototxt"
...
o_conv1_1_w.resize((128, 3, 3, 3))
o_conv1_1_b.resize((128,))
...
o_conv1_2_w.resize((128, 64, 3, 3))
o_conv1_2_b.resize((128,))
x = np.zeros((128, 64, 3, 3), dtype=float)
o_conv1_2_w = np.concatenate((o_conv1_2_w, x), axis=1) # (128, 128, 3, 3)
...
o_conv2_1_w.resize((128, 64, 3, 3))
# o_conv2_1_b.resize((128,))
o_conv2_1_w = np.concatenate((o_conv2_1_w, x), axis=1) # (128, 128, 3, 3)
...
# o_conv2_2_w.resize((128, 128, 3, 3))
# o_conv2_2_b.resize((128,))
...
obfuscated_net.save('O_VGG_ILSVRC_16_layers_less_opt.caffemodel')
